...
if not os.path.exists("bingo_generator.py"):
	print("Please execute this program from its folder.")
	exit()

# Define configuration
bingo_size = {"lines": 3, "columns": 3}
bingo_namespace = "first_bingo"
bingo_name = "First Bingo"
advancements_folder = "pickable_advancements"
configuration_objective = "simplenergy.data"
...
execute if score #{bingo_namespace}_enabled {configuration_objective} matches 1 run data modify storage {bingo_namespace} {line}_{column} set value {{title:"{advancement["display"]["title"]["text"]}", description:"{advancement["display"]["description"]["text"]}"}}
